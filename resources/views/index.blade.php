...
<div class="position-fixed">
    <h6 style="font-size: 15px;">Teman Anda yang sudah Join BeeBook</h6>
    <ul class="list-group ">
        ...
        <div class="card">
            <div class="card-body">
                <p class="card-text ml-4"><a href="" style="text-decoration:none;color:gray; font-size:20px;"
                        ...
                        anda pikirkan,
                        {{auth()->user()->name}} ?</a></p>
                <a href="#" class="btn btn-warning float-right" data-toggle="modal" data-target="#exampleModal">Tambah
                    Post</a>
        ...
        <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        @if ($postingan->gambar !== null)
                            <img src="{{ asset('img/post/' . $postingan->gambar) }}"
                                class="card-img-top m-auto  img-fluid" width="5px">
                        @endif
                        <div class="mb-2 mt-2">
            ...
            <div class="card-footer">
                ...
                <div>
                    <form action="/komen/{{$postingan->id}}" method="POST">
                        ...
                        <button type="submit" class="btn-sm btn-warning float-right"><i
