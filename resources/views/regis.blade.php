...
<head>
    ...
    <!-- Icon -->
    <link rel="shortcut icon" href="/img/beebook1">
    <title>BeeBook</title>
</head>

<body>

<nav class="navbar navbar-secondary bg-white">
        <a class="navbar-brand" href="#">
            <img src="/img/beebook1.png" class="img-rounded" width="100%" height="55" wide="110" alt="">
        </a>
        <form action="/postlogin" class="form-inline" method="post">
            ...
            <input type="submit" value="Login" class="btn btn-warning my-2 my-sm-0">
        </form>
    </nav>
    @if (session('gagal'))
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <form action="/regis" method="post">
                                ...
                                <input type="submit" value="Registrasi" class="btn btn-block btn-warning">
                            </form>
                        </div>
                    </div>
